...
# creat a Excel file
wb = Workbook()
wb.save('Liste de travailleurs.xlsx')
...
for name in names :
    ...
    for link in detail_links:
        ...
        # add to the sheet
        sheet[f'A{sheet_line}'] = prenom
        sheet[f'B{sheet_line}'] = nom
        sheet[f'C{sheet_line}'] = employeur
        sheet[f'D{sheet_line}'] = telephone
        #sheet[f'E{sheet_line}'] = employeur #permis
        #sheet[f'F{sheet_line}'] = etablissement
        #sheet[f'G{sheet_line}'] = adresse
        #sheet[f'H{sheet_line}'] = telephone #statut
